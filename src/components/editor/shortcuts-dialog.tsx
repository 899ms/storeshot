...
const SHORTCUTS: { keys: string; action: string }[] = [
  ...
  { keys: "Alt + A / D", action: "Align Left / Right" },
  { keys: "Alt + W / S", action: "Align Top / Bottom" },
  { keys: "Alt + H / V", action: "Align Center / Middle" },
  { keys: "Ctrl + Alt + H / V", action: "Distribute Spacing" },
  { keys: "Shift + Click", action: "Add to Selection" },
  { keys: "Ctrl (hold)", action: "Suspend Snapping While Dragging" },
  { keys: "Shift (rotate)", action: "Snap Rotation to 15°" },
  { keys: "Shift + H / V", action: "Flip Horizontal / Vertical" },
